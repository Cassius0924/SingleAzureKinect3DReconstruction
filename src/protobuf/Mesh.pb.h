...
class V1 final :
 ...
 public:
  ...
  ~V1() override;
  explicit PROTOBUF_CONSTEXPR V1(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class V2 final :
 ...
 public:
  ...
  ~V2() override;
  explicit PROTOBUF_CONSTEXPR V2(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class V3 final :
 ...
 public:
  ...
  ~V3() override;
  explicit PROTOBUF_CONSTEXPR V3(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
