...
// 发送Protobuf消息到网络对端
bool cas::net::proto::send_message(int fd, google::protobuf::Message& message) {
...
// 发送exit_mesh
bool cas::net::proto::send_exit_mesh_message(int fd) {
	cas::proto::DataMessage message;
	message.set_type(cas::proto::DataMessage::EXIT_MESH);
	return cas::net::proto::send_message(fd, message);
}
